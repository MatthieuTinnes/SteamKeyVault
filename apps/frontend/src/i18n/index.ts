...
const messages = {
  en: {
    ...
    home: {
      eyebrow: 'Free to Use · Secure by Design · Open Source',
    ...
    games: {
      ...
      platformPlaceholder: 'Select or type a platform',
      platformHint: 'Choose from suggestions or enter any platform name (optional).',
      platformNotSet: 'Not set',
      platformAdd: 'Add platform',
      platformEdit: 'Edit platform',
      platformSavedSummary: 'Platform updated',
      platformSavedDetail: 'Platform has been saved.',
  ...
  fr: {
    ...
    home: {
      eyebrow: 'Gratuit · Sécurisé · Open Source',
    ...
    games: {
      ...
      platformPlaceholder: 'Choisissez ou saisissez une plateforme',
      platformHint: 'Choisissez parmi les suggestions ou entrez un nom de plateforme libre (optionnel).',
      platformNotSet: 'Non définie',
      platformAdd: 'Ajouter une plateforme',
      platformEdit: 'Modifier la plateforme',
      platformSavedSummary: 'Plateforme mise à jour',
      platformSavedDetail: 'La plateforme a été enregistrée.',
      platformSaveFailed: "Échec de l'enregistrement de la plateforme.",
